...
class CsvFileParser extends FileParser
{
    ...
    /**
     * В случае больших файлов, надо читать файл по одной строке.
     * Хранить в памяти только общее кол-во строк и необходимые для отображения строки.
     * (для этого понадобится номер страницы и кол-во отображаемых строк)
     * @return array|bool
     */
